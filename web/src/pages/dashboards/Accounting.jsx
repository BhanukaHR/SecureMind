    ...
    <div className="container my-4" style={{maxWidth:1200}}>
      ...
      <Page title="Quick Links">
        ...
        <div className="col-12 col-md-6 col-lg-4">
          <div className="card h-100 border-0 glass-card hover-lift">
            <div className="card-body">
              <div className="fw-bold mb-1">Invoice Fraud Detective</div>
              <div className="text-body-secondary small mb-3">Spot doctored invoices.</div>
              <Link to="/accounting/invoice-fraud" className="btn btn-outline-primary btn-sm">Open</Link>
            </div>
          </div>
        </div>
        \n
        <div className="col-12 col-md-6 col-lg-4">
          <div className="card h-100 border-0 glass-card hover-lift">
            <div className="card-body">
              <div className="fw-bold mb-1">Compliance Quizzes</div>
              <div className="text-body-secondary small mb-3">Financial protocols.</div>
              <Link to="/accounting/quizzes" className="btn btn-outline-primary btn-sm">Open</Link>
            </div>
          </div>
        </div>
